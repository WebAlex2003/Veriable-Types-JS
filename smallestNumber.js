...
/* Напиши скрипт который найдет самое маленькое число в массиве значений  */

/* Найди самое маленькое число в массиве значений с помощью  */

const array1 = [1, 2, 3, 4, 5, 6, 7, 8];
const array2 = [1, 50, 65, 78, 38];

const generalArray = [...array1,...array2]

console.log(Math.min(...generalArray));
console.log(Math.max(...generalArray));